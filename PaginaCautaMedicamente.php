<?php
include_once 'PaginaMedicamente.php';
$cautaMedi=new CautaMedicamentee();

if(isset($_POST['submit']))  {
    if($_POST['denn']!==''){
        $cautaMedi->searchCautaMedicamentee($_POST['denn']);
    }
    //unset($_POST['search']);
}
...
<div>
    <form action="PaginaCautaMedicamente.php" method="post">
        <div class="container">
...
<br>
<?php
$cautaMedi->getCautaMedica($_POST['search']);
